...
namespace CHWGameEngine.Motion
{
    public abstract class MotionBehavior : IMotionBehavior
    {
        ...
        protected void CalcSpeed()
        {
            ...
            NewSpeed.X = GameObject.ActualSpeed * Math.Sin(DegreesToRadians((int)GameObject.Angle));
            NewSpeed.Y = -(GameObject.ActualSpeed * Math.Cos(DegreesToRadians((int)GameObject.Angle)));
